...
export default new Router({
  ...
  // S2
  { path: '/s2', name: 's2', component: require('../components/s1/List.vue').default, beforeEnter: requireAuth },
  { path: '/s2/create', name: 'create-s2', component: require('../components/s1/Create.vue').default, beforeEnter: requireAuth },
  { path: '/s2/:id/edit', name: 'edit-s2', component: require('../components/s1/Edit.vue').default, beforeEnter: requireAuth },
