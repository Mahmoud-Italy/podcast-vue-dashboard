                            ...
                            <table id="printMe" class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 25%">Encoding tool</th>
                                ...
                                <tbody v-if="!dataLoading && rows.length">
                                    ...
                                    <td class="font-weight-semi-bold">
                                        <p v-if="row.languages.length">
                                            <label class="badge badge-primary btn-sm" 
                                                style="margin-right: 5px" 
                                                v-for="(lang, idx) in row.languages"
                                                :key="idx">
                                                {{ lang }}
                                            </label>
                                        </p>
                                    ...
                                    <td class="font-weight-semi-bold text-center">
                                       <p v-if="row.encoding_tool.length">
                                            <label class="badge badge-success btn-sm" 
                                                style="margin-right: 5px" 
                                                v-for="(tool, idx) in row.encoding_tool"
                                                :key="idx">
                                                {{ tool }}
                                            </label>
                                        </p>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>Languages</th>
                                        <th class="text-center">Encoding tool</th>
